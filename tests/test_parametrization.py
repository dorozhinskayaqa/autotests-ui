...
@pytest.mark.parametrize(
    "email,password",
    [
        param("", "123", id="empty_email"),
        param("user@mail.com", "", id="empty_password"),
        param("  ", "  ", id="empty_credentials"),
        param("usr@mail.com", "123456", id="wrong_email"),
        param("user@mail.com", "111111", id="wrong_password")
    ]
)
