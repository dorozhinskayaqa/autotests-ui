...
class LoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.registration_link = Link(page, 'login-page-registration-link', 'RegistrationLink')
    ...
    def check_visible_wrong_email_or_password_alert(self):
        ...
        self.wrong_email_or_password_alert.check_has_text('Wrong email or password')
