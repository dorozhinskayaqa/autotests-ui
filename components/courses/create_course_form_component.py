...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.estimated_time_input = Input(page,'create-course-form-estimated-time-input', 'Estimated input')
    ...
    def check_visible(
        ...
        self.title_input.check_has_value(title)

        self.estimated_time_input.check_visible()
        self.estimated_time_input.check_has_value(estimated_time)

        self.description_textarea.check_visible()
        self.description_textarea.check_has_value(description)

        self.max_score_input.check_visible()
        self.max_score_input.check_has_value(max_score)

        self.min_score_input.check_visible()
        self.min_score_input.check_has_value(min_score)
