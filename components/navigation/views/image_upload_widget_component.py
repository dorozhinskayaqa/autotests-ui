...
class ImageUploadWidgetComponent(BaseComponent):
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        ...
        self.image_upload_info_title.check_has_text('Tap on "Upload image" button to select file')

        self.image_upload_info_description.check_visible()
        self.image_upload_info_description.check_has_text('Recommended file size 540X300')
